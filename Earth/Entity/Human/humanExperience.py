...
class humanExperience:
    def __init__(self):
        ...
        self.phobias = common.getListFile("Earth/Entity/Human/Lists/Phobias")
        self.Traumas = common.getListFile("Earth/Entity/Human/Lists/Traumas")
        self.Crimes = common.getListFile("Earth/Entity/Human/Lists/Crimes")
