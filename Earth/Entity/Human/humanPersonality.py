...
class humanPersonality:
    def __init__(self):
        f = open("Earth/Entity/Human/Lists/SchoolsOfThought", "r", encoding='iso-8859-15')
        ...
        self.pets = common.getListFile("Earth/Entity/Human/Lists/Pets")
        self.allHobbies = common.getListFile("Earth/Entity/Human/Lists/Hobbies")
        self.eInterests = common.getListFile("Earth/Entity/Human/Lists/EducationalInterests")
        self.languages = common.getListFile("Earth/Entity/Human/Lists/Languages")
        self.bodyParts = common.getListFile("Earth/Entity/Human/Lists/BodyParts")
        self.BadHabits = common.getListFile("Earth/Entity/Human/Lists/BadHabits")
        ...
        self.englishWordlist = common.getListFile("Earth/Entity/Human/Lists/EnglishWordlist")
    ...
    def makePersonality(self, char):
        ...
        #Habits
        char["Bad Habits"] = common.returnMultiple(random.randint(1,6), self.BadHabits)
